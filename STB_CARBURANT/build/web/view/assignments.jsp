...
<body>        
            ...
            <div class="p-4 pt-5">
               <h6 style="color: #D0D0D0"><i style="color: #D0D0D0" class="fa fa-user-circle-o"></i> ${user.lastName} ${user.firstName} </h6>
                ...
                <ul class="list-unstyled components mb-5">
                    ...
                    <li class="active">
                        <a href="assignments?action=list"><i class="fa fa-id-card fa-lg"></i> Affectations</a>
                    </li> 
                    <br>
                    <li>
    ...
    <div id="content" class="p-4 p-md-5 pt-5">
        <div class="row">
            <div class="col-sm-6">
                <h1 class="text-logo"> <i class="fa fa-list fa-lg"></i> Liste des affectations conducteur-véhicule</h1>
            </div>
            <div class="col-sm-6" >
        ...
        <table class="table" id="table" >
            <thead style="text-align: center">
                ...
                <th scope="col" onclick="sortTable(2)">Km initial  <i class="fa fa-sort"></i></th>
                  ...
                  <th scope="col" onclick="sortTable(4)">Conso moy<i class="fa fa-sort"></i></th>
                <th scope="col" onclick="sortTable(5)">État  <i class="fa fa-sort"></i></th>
