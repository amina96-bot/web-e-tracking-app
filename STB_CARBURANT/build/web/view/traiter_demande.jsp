...
<body>
    ...
    %>
        ...
        <div id="content" class="p-4 p-md-5 pt-5">
            ...
            <form id="form1" action="update_demande_chargement?action=detail&traitement=refuser&kmId=<%= kilometrage.getId() %>&id=<%= assignmentId %>"   method="post">  
               <div class="row">   
                    <h5 id="motifH" class="text-detail"> <i class="fa fa-calendar "></i> Motif de refus:</h5> 
                    <input type="text" class="textInput" id="motif" name="motif" placeholder="Motif de refus">            
                </div>
                    <br><br>
                <div  class="row">
            ...
            <div  class="row" >
                <div class="col-sm-6" style="text-align: center;">      
                    <a id="btnRefuser" onclick="myFunction1()"  style="background-color: #db2121;float:left;color: white" class="formInput" >Refuser</a>
                </div>
                <div class="col-sm-6"  style="text-align: center;">
                <a id="btnAccepter" href="update_demande_chargement?action=detail&traitement=accepter&kmId=<%= kilometrage.getId() %>&id=<%= assignmentId %>"  style="background-color: #4CAF50;float: right;color: white" class="formInput" >Accepter</a>   
                </div>                  
            </div> 
        </div>
    ...
    function myFunction1() {
      ...
      document.getElementById("btnRefuser").style.visibility = 'hidden';
      document.getElementById("btnAccepter").style.visibility = 'hidden';
    }
    </script>
