    ...
    <header>
		...
		<div class="p-4 pt-5">
                    ...
                    <ul class="list-unstyled components mb-5">
                        ...
                        <li class="active">
                            <a href="drivers?action=list"><i class="fa fa-male  fa-lg"></i> Conducteurs</a>
                        </li>
        ...
        <div id="content" class="p-4 p-md-5 pt-5">
            <div class="row">
                <div class="col-sm-6">
                    <h1 class="text-logo"> <i class="fa fa-list fa-lg"></i> Liste des conducteurs</h1>
                </div>
                <div class="col-sm-6" >
                  <%  if(user.getRoles().contains("administrateur")) { %>
                        <a  style="float:right" href="drivers?action=add" class="add-button"  title="Ajouter un conducteur"><i  class="fa fa-plus"></i></a>
                          <% }  %>
            ...
            <table class="table" id="table">
                <thead  style="text-align: center">
                    ...
                    <th scope="col" onclick="sortTable(0)">Nom  <i class="fa fa-sort"></i></th>
                    <th scope="col" onclick="sortTable(1)">Prénom <i class="fa fa-sort"></i></th>
                    <th scope="col" onclick="sortTable(2)">Département <i class="fa fa-sort"></i></th>
                     <th scope="col" onclick="sortTable(3)">Région <i class="fa fa-sort"></i></th>
                    <th scope="col" onclick="sortTable(4)">Utilisateur actif <i class="fa fa-sort"></i></th>
                       <%  if(user.getRoles().contains("administrateur")) { %>
                    ...
                    <% 
                        ...
                        %>
                        <tr style="text-align: center" onclick="document.location='drivers?action=driver_assignments&id=<%= users.get(i).getId() %>';">
                            <td><%= users.get(i).getEmployee().getLastName()  %></td>
                            <td><%= users.get(i).getEmployee().getFirstName() %></td>
                            <td><%= users.get(i).getEmployee().getDepartement() %></td>
                            <td><%= users.get(i).getEmployee().getRegion() %></td>
                            ...
                            <td style="text-align: center"> 
                                <a href="drivers?action=detail&id=<%= users.get(i).getId() %>"><i style="color: green" class="fa fa-eye fa-lg"></i></a> 
                               &nbsp;&nbsp;&nbsp;
                                <%  if(user.getRoles().contains("administrateur")) { %>
                                <a href="drivers?action=update&id=<%= users.get(i).getId() %>"><i style="color: blue" class="fa fa-edit fa-lg"></i></a> 
                               &nbsp;&nbsp;&nbsp;
                               <a href="drivers?action=delete&id=<%= users.get(i).getId() %>" onclick="return confirm('Êtes-vous sûr de vouloir supprimer?')"><i style="color: red" class="fa fa-trash fa-lg"></i></a> 
                            <% } %>
                            </td>
            ...
            <script type="text/javascript">                
                function ExportToExcel(type, fn, dl) {
                    ...
                    return dl ?
                      ...
                      XLSX.writeFile(wb, fn || ('conducteurs_list.' + (type || 'xlsx')));
                 }
            </script>
