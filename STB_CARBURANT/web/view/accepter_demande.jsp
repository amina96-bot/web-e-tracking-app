...
<body>
    ...
    %>
        ...
        <div id="content" class="p-4 p-md-5 pt-5">
            ...
            <div class="row">
                <div class="col-sm-6">
                     <h1 class="text-logo"> <i class="fa fa-info-circle "></i> Accepter la demande de chargement</h1>
            ...
            <div  class="row" >
                <div class="col-sm-6" style="text-align: center;">      
                    ...
                    <a href="view/refuser_demande.jsp" style="background-color: #db2121;float:left;color: white" class="formInput" >Refuser</a>
                </div>
                <div class="col-sm-6"  style="text-align: center;">
                <a href="view/accepter_demande.jsp" style="background-color: #4CAF50;float: right;color: white" class="formInput" >Accepter</a>                  
                </div>                  
            </div>                         
        </div>
