...
<head>
    <meta charset="utf-8">
    <title>Liste des affectations avec de nouvelles demandes de chargement</title>
...
<body>        
    ...
    <div id="content" class="p-4 p-md-5 pt-5">
        <div class="row">
            <div class="col-sm-8">
                <h1 class="text-logo"> <i class="fa fa-list"></i> Nouvelles demandes de chargement en attente de validation</h1>
            </div>
            <div class="col-sm-4" >
