...
<body>        
    ...
    <div id="content" class="p-4 p-md-5 pt-5">
        <div class="row">
            <div class="col-sm-6">
                <h1 class="text-logo"> <i class="fa fa-list fa-lg"></i> Liste des affectations associées au véhicule: </h1>
            </div>
            <div class="col-sm-6" >
        ...
        <div class="border" style="text-align:center"> 
             <div class="row">
                <div class="col-sm-6">
                    <h5 class="text-detail"> <i class="fa fa-car"></i> Code</h5> 
                    
                </div>
                <div class="col-sm-6" > 
                    <h5 class="text-detail"> <i class="fa fa-car"></i> N° d'immatriculation</h5>                            
               </div>          
            </div>
         <% 
