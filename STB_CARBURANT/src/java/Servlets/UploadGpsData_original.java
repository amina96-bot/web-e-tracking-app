...
@WebServlet(name = "UploadGpsData_original", urlPatterns = {"/UploadGpsData_original"})
@MultipartConfig
public class UploadGpsData_original extends HttpServlet {
        ...
        try (PrintWriter out = response.getWriter()) {
            try{
              ...
              try {            
                ...
                Logger.getLogger(UploadGpsData_original.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    }
